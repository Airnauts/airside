    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal container={container ?? undefined}>
        ...
        <Dialog.Content className="air:fixed air:top-1/2 air:left-1/2 air:-translate-x-1/2 air:-translate-y-1/2 air:bg-white air:p-6 air:rounded-xl air:min-w-80 air:pointer-events-auto">
          <Dialog.Title className="air:mt-0">Log in to comment</Dialog.Title>
          <Dialog.Description>
          ...
          <form onSubmit={submit}>
            <input
              ...
              className="air:block air:w-full air:my-3 air:p-2 air:border air:border-gray-300 air:rounded-[4px]"
            />
            <input
